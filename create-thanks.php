...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="exampleModalLabel">Danksagung</h4>
</div>
<div id="modal-body" class="modal-body">
    <div class="form-group">

        <textarea class="form-control" id="declaration" rows="5" placeholder="Danksagung einfügen"></textarea>
        <label class="sr-only" for="declaration">Danksagung</label>
