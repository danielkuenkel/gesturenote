...
//        console.log(currentPhaseData);
        ...
        switch (currentPhase.selectedId) {
            ...
            case GUS_SINGLE_GESTURES:
                item = Tester.getGUS(source, container, currentPhaseData);
                break;
    ...
    renderUnmoderatedTraining: function renderUnmoderatedTraining(source, container, data) {
        var trainingData = data[currentGestureTrainingIndex];
        var item = $(source).find('#trainingItemUnoderated').clone().removeAttr('id');
    ...
    renderUnmoderatedSlideshow: function renderUnmoderatedSlideshow(source, container, data) {
