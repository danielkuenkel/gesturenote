...
//                }
    ...
    // get all gestures in shared gesture sets, which are noch shared explicitly
    ...
    echo json_encode(array('status' => 'success', 'gestures' => $gestures, 'sharedSetGestures' => $sharedSetGesturesArray, 'sharedGestures' => $sharedGestures));
    exit();
} else {
