...
if (isset($_SESSION['user_id'])) {
    ...
    if ($gestures_stmt = $mysqli->prepare("SELECT * FROM gestures ORDER BY created ASC")) {
        if (!$gestures_stmt->execute()) {
            ...
            $gestures_stmt->bind_result($id, $userId, $ownerId, $source, $scope, $title, $type, $interactionType, $context, $association, $description, $joints, $previewImage, $images, $gif, $created);
