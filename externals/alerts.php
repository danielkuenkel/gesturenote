...
<div id="alert-container" class="hidden">
    ...
    <div class="alert alert-danger"  id="no-study-gestures-assembled-link" role="alert"><i class="glyphicon glyphicon-alert"></i> <span class="alert-text"><?php echo $lang->alerts->noStudyGesturesAssembledLink->text ?></span></div>
    ...
    <div class="alert alert-danger"  id="no-trigger-assembled-link" role="alert"><i class="glyphicon glyphicon-alert"></i> <span class="alert-text"><?php echo $lang->alerts->noTriggerAssembledLink->text ?></span></div>
    ...
    <div class="alert alert-danger"  id="no-feedback-assembled-link" role="alert"><i class="glyphicon glyphicon-alert"></i> <span class="alert-text"><?php echo $lang->alerts->noFeedbackAssembledLink->text ?></span></div>
    ...
    <div class="alert alert-warning" id="sound-to-large" role="alert"><i class="glyphicon glyphicon-alert"></i> <span class="alert-text"><?php echo $lang->alerts->soundToLarge->text ?></span></div>
    ...
    <div class="alert alert-warning" id="search-participation-requests" role="alert"><i class="glyphicon glyphicon-alert"></i> <span class="alert-text"><?php echo $lang->alerts->searchParticipationRequests->text ?></span></div>
    ...
    <div class="alert alert-warning" id="no-trigger-classified" role="alert"><i class="glyphicon glyphicon-alert"></i> <span class="alert-text"><?php echo $lang->alerts->noTriggerClassified->text ?></span></div>
    ...
    <div class="alert alert-warning" id="no-more-trigger-for-classification" role="alert"><i class="glyphicon glyphicon-alert"></i> <span class="alert-text"><?php echo $lang->alerts->noMoreTriggerForClassification->text ?></span></div>
    ...
    <div class="alert alert-warning" id="no-data-ueq-questionnaire" role="alert"><i class="glyphicon glyphicon-alert"></i> <span class="alert-text"><?php echo $lang->alerts->noDataUEQQuestionnaire->text ?></span></div>
