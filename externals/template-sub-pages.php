    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="sub-page-header">
        <div class="container">
            <div class="navbar-header" id="logo">
                ...
                <a class="navbar-brand"><i class="glyphicon glyphicon-stats"></i> GestureNote <sup><span class="label label-success" style="position: relative; font-size: 6pt; letter-spacing: normal">ALPHA</span></sup></a>
            </div>
            <div>
                <ul class="nav navbar-nav navbar-right">
                    <li id="btn-sign-out"><a href="includes/logout.php"><i class="glyphicon glyphicon-log-out"></i> <span class="btn-text uppercase"></span></a></li>
                </ul>
            </div>
        </div>
