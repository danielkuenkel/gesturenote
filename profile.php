    ...
    <body id="pageBody" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <script>
            ...
            $('#update-form').on('submit', function (event) {
                ...
                if (p !== null && pO !== null) {
                    updateUser({forename: forename, surname: surname, email: email, p: p, pO: pO, date: date, month: month, year: year}, function (result) {
                        if (result.status === RESULT_SUCCESS) {
                            $('#user-forename .text').text(forename);
                            $('#user-surname .text').text(surname);
                            $('#user-email .text').text(email);
                            $('#user-birthday .text').text(year + "-" + month + "-" + date);
                            $('#general-edit').addClass('hidden');
                            $('#general-preview').removeClass('hidden');
                    ...
                    updateUser({forename: forename, surname: surname, email: email, date: date, month: month, year: year}, function (result) {
                        if (result.status === RESULT_SUCCESS) {
                            $('#user-forename .text').text(forename);
                            $('#user-surname .text').text(surname);
                            $('#user-email .text').text(email);
