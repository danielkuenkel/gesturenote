...
//        console.assert(data[key]);
                ...
                if (xhr.readyState === xhr.DONE) {
                    if (xhr.status === 200 || xhr.status === 0) {
                        if (xhr.responseText) {
                            ...
                            recording.readFileData(xhr.responseText, null, callback);
        ...
        readFileData: function (responseData, file, callback) {
            var url = this.url;
            if (file && file.name) {
                url = file.name;
            }
...
//                });
            ...
            play: function () {
                ...
                if (!this.recording || this.loading() || this.recording.blank())
                    return;
        ...
        var playback = function (scope) {
            ...
            scope.player = new Player(controller, {
